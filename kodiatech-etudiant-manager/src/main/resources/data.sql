...
INSERT INTO STUDENT(ID, LAST_NAME, FIRST_NAME, SEXE, EMAIL, DEPARTMENT_ID)
SELECT 1, 'tra', 'kaba', 'M', 'kaba@gmail.com', 1
WHERE NOT EXISTS (SELECT 1 FROM STUDENT WHERE EMAIL = 'kaba@gmail.com');

INSERT INTO STUDENT(ID,LAST_NAME, FIRST_NAME, SEXE, EMAIL, DEPARTMENT_ID)
SELECT 2,'keita', 'mamady', 'M', 'keita@gmail.com', 1
WHERE NOT EXISTS (SELECT 1 FROM STUDENT WHERE EMAIL = 'keita@gmail.com');

INSERT INTO STUDENT(ID,LAST_NAME, FIRST_NAME, SEXE, EMAIL, DEPARTMENT_ID)
SELECT 3,'tra', 'kaman', 'M', 'kaman@gmail.com', 1
WHERE NOT EXISTS (SELECT 1 FROM STUDENT WHERE EMAIL = 'kaman@gmail.com');

INSERT INTO STUDENT(ID,LAST_NAME, FIRST_NAME, SEXE, EMAIL, DEPARTMENT_ID)
SELECT 5,'tra', 'koman', 'M', 'koman@gmail.com', 1
